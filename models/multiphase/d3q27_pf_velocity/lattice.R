...
AddDensity( name="e0", dx= 0, dy= 0, dz= 0, group="e")
AddDensity( name="e1", dx= 1, dy= 0, dz= 0, group="e")
AddDensity( name="e2", dx=-1, dy= 0, dz= 0, group="e")
AddDensity( name="e3", dx= 0, dy= 1, dz= 0, group="e")
AddDensity( name="e4", dx= 0, dy=-1, dz= 0, group="e")
AddDensity( name="e5", dx= 0, dy= 0, dz= 1, group="e")
AddDensity( name="e6", dx= 0, dy= 0, dz=-1, group="e")
AddDensity( name="e7", dx= 1, dy= 1, dz= 1, group="e")
AddDensity( name="e8", dx=-1, dy= 1, dz= 1, group="e")
AddDensity( name="e9", dx= 1, dy=-1, dz= 1, group="e")
AddDensity( name="e10",dx=-1, dy=-1, dz= 1, group="e")
AddDensity( name="e11",dx= 1, dy= 1, dz=-1, group="e")
AddDensity( name="e12",dx=-1, dy= 1, dz=-1, group="e")
AddDensity( name="e13",dx= 1, dy=-1, dz=-1, group="e")
AddDensity( name="e14",dx=-1, dy=-1, dz=-1, group="e")
